        ...
        <ScrollArea.Viewport className="h-full w-full p-4">
          {!hasSources ? (
            <div className="text-center py-8">
              <div className="mx-auto w-10 h-10 rounded-full bg-muted flex items-center justify-center mb-3" aria-hidden="true">
...
function SourceCard({ citation, number, onClick }: SourceCardProps) {
  ...
  return (
    <button
      ...
      aria-label={`Source ${number}: ${citation.file_name}, ${citation.location}`}
    >
      <div className="flex items-start gap-2">
        <span className="flex h-5 min-w-5 items-center justify-center rounded bg-primary/10 text-primary text-xs font-medium" aria-hidden="true">
          {number}
        </span>
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label={`Open ${citation.file_name} in Google Drive`}
            >
